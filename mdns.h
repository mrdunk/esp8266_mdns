...
struct Answer{
  ...
  int PopulateResultBuffer(byte* p_packet_buffer, int packet_buffer_pos, int packet_buffer_len);
...
int nameFromDnsPointer(char* p_name_buffer, int name_buffer_pos, int name_buffer_len, byte* p_packet_buffer, int packet_buffer_pos);
